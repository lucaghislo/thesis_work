...
# Read data and read tree fuctions for adult data
...
def read_data():
    ...
    data_file = open('data/adult_dataset/adult.csv', 'rU')
    ...
    for i in range(QI_num):
        if IS_CAT[i] is False:
            static_file = open('data/adult_dataset/adult_' + ATT_NAMES[QI_INDEX[i]] + '_static.pickle', 'wb')
...
def read_pickle_file(att_name):
    ...
    """
    try:
        static_file = open('data/adult_dataset/adult_' + att_name + '_static.pickle', 'rb')
...
def read_tree_file(treename):
    ...
    leaf_to_path = {}
    att_tree = {}
    prefix = 'data/adult_dataset/adult_'
    postfix = ".txt"
